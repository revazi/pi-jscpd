...
| `effect` | Exact `3.22.1` | `3.22.1` | Reviewed MIT runtime for scoped process/analyzer and bounded-filesystem resources; the single managed Pi runtime lands in M7.7. |
