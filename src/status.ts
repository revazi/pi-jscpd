...
import type {
  JscpdProcess,
  JscpdWorkflowRequirements as JscpdRuntimeRequirements,
...
function statusInspectEffect(
  ...
  return status.inspectEffect(context);
}
